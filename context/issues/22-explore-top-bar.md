...
**What to build:** Compact top bar on Explore (`/`) with HanapBidet logo/brand, glassmorphic styling per UI_DESIGN, and safe-area padding for mobile notches. Radius and filter slots are present as layout placeholders (wired in later tickets). Theme toggle slot reserved.
